...
export default function Actualites() {
  ...
  return (
    <div className="p-6 bg-gray-100 dark:bg-neutral-900">
      <h1 className="text-2xl md:text-3xl font-bold text-neutral-800 dark:text-neutral-100 mb-8">Actualités Livar</h1>
      ...
      <div className="mb-8 p-4 bg-white dark:bg-neutral-800 rounded-lg shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Input
            ...
            className="bg-gray-100 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-100 border-gray-300 dark:border-neutral-600"
          />
          <Select onValueChange={setFiltreSecteur} value={filtreSecteur}>
            <SelectTrigger className="bg-gray-100 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-100 border-gray-300 dark:border-neutral-600">
